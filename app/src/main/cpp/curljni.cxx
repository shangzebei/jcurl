...
void SwigDirector_Progress::progress(unsigned long long unow, unsigned long long utotal, unsigned long long dnow, unsigned long long dtotal) {
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  jobject swigjobj = (jobject) NULL ;
  jobject junow  ;
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    {
      ...
      for(swig_i=1; swig_i<9; swig_i++ ) {
        bae[swig_i] = (jbyte)(unow>>8*(8-swig_i));
      }
    ...
    Swig::LocalRefGuard unow_refguard(jenv, junow);
    {
      jbyteArray ba = jenv->NewByteArray(9);
      jbyte* bae = jenv->GetByteArrayElements(ba, 0);
      jclass clazz = jenv->FindClass("java/math/BigInteger");
      ...
      bae[0] = 0;
      for(swig_i=1; swig_i<9; swig_i++ ) {
        bae[swig_i] = (jbyte)(utotal>>8*(8-swig_i));
      }
    ...
    Swig::LocalRefGuard utotal_refguard(jenv, jutotal);
    {
      jbyteArray ba = jenv->NewByteArray(9);
      jbyte* bae = jenv->GetByteArrayElements(ba, 0);
      jclass clazz = jenv->FindClass("java/math/BigInteger");
      ...
      bae[0] = 0;
      for(swig_i=1; swig_i<9; swig_i++ ) {
        bae[swig_i] = (jbyte)(dnow>>8*(8-swig_i));
      }
    ...
    Swig::LocalRefGuard dnow_refguard(jenv, jdnow);
    {
      jbyteArray ba = jenv->NewByteArray(9);
      jbyte* bae = jenv->GetByteArrayElements(ba, 0);
      jclass clazz = jenv->FindClass("java/math/BigInteger");
      ...
      bae[0] = 0;
      for(swig_i=1; swig_i<9; swig_i++ ) {
        bae[swig_i] = (jbyte)(dtotal>>8*(8-swig_i));
      }
    ...
    Swig::LocalRefGuard dtotal_refguard(jenv, jdtotal);
...
void SwigDirector_Progress::swig_connect_director(JNIEnv *jenv, jobject jself, jclass jcls, bool swig_mem_own, bool weak_global) {
  static struct {
    ...
    {
      "progress", "(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", NULL 
    }
  };
...
SWIGEXPORT void JNICALL Java_s_docker_com_jcurl_CurlUtilsJNI_Progress_1progress(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobject jarg2, jobject jarg3, jobject jarg4, jobject jarg5) {
  ...
  }
  {
    ...
    arg4 = 0;
    if (sz > 0) {
      arg4 = (unsigned long long)(signed char)bae[0];
      for(i=1; i<sz; i++) {
        arg4 = (arg4 << 8) | (unsigned long long)(unsigned char)bae[i];
      }
    }
    jenv->ReleaseByteArrayElements(ba, bae, 0);
  }
  {
    ...
    arg5 = 0;
    if (sz > 0) {
      arg5 = (unsigned long long)(signed char)bae[0];
      for(i=1; i<sz; i++) {
...
SWIGEXPORT void JNICALL Java_s_docker_com_jcurl_CurlUtilsJNI_Progress_1progressSwigExplicitProgress(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobject jarg2, jobject jarg3, jobject jarg4, jobject jarg5) {
  Progress *arg1 = (Progress *) 0 ;
  unsigned long long arg2 ;
  unsigned long long arg3 ;
  unsigned long long arg4 ;
...
SWIGEXPORT void JNICALL Java_s_docker_com_jcurl_CurlUtilsJNI_swig_1module_1init(JNIEnv *jenv, jclass jcls) {
  ...
  static struct {
    ...
    {
      "SwigDirector_Progress_progress", "(Ls/docker/com/jcurl/Progress;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V" 
    }
  };
