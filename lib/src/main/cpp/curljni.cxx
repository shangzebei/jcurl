...
void SwigDirector_Progress::progress(long long unow, long long utotal, long long dnow, long long dtotal) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    jenv->CallStaticVoidMethod(Swig::jclass_CurlUtilsJNI, Swig::director_methids[2], swigjobj, junow, jutotal, jdnow, jdtotal);
...
SWIGEXPORT jint JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormData_1Type_1TEXT_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  ParamFormData::Type result;
  
  (void)jenv;
  (void)jcls;
  result = (ParamFormData::Type)ParamFormData::Type::TEXT;
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormData_1name_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  ParamFormData *arg1 = (ParamFormData *) 0 ;
  std::string *arg2 = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(ParamFormData **)&jarg1; 
  if(!jarg2) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "null string");
    return ;
  }
...
SWIGEXPORT void JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormData_1type_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  ParamFormData *arg1 = (ParamFormData *) 0 ;
  ParamFormData::Type arg2 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(ParamFormData **)&jarg1; 
  arg2 = (ParamFormData::Type)jarg2; 
...
SWIGEXPORT jint JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormData_1type_1get(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  result = (ParamFormData::Type) ((arg1)->type);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jlong JNICALL Java_com_my_jcurl_CurlUtilsJNI_new_1ParamFormData(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  ParamFormData *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  
  try {
    result = (ParamFormData *)new ParamFormData();
  } catch (std::exception& e) {
    SWIG_JavaException(jenv,SWIG_RuntimeError,e.what());
  }
  
  *(ParamFormData **)&jresult = result; 
  return jresult;
}
...
SWIGEXPORT jlong JNICALL Java_com_my_jcurl_CurlUtilsJNI_CurlUtil_1uploadMultiFile_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jstring jarg1, jlong jarg2, jobject jarg2_, jlong jarg3, jobject jarg3_) {
  jlong jresult = 0 ;
  std::string arg1 ;
  std::map< std::string,ParamFormData * > arg2 ;
  Response *arg3 = (Response *) 0 ;
  std::map< std::string,ParamFormData * > *argp2 ;
  CurlUtil *result = 0 ;
  ...
  (&arg1)->assign(arg1_pstr);
  jenv->ReleaseStringUTFChars(jarg1, arg1_pstr); 
  argp2 = *(std::map< std::string,ParamFormData * > **)&jarg2; 
  if (!argp2) {
...
SWIGEXPORT jlong JNICALL Java_com_my_jcurl_CurlUtilsJNI_new_1ParamFormMap_1_1SWIG_10(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  std::map< std::string,ParamFormData * > *result = 0 ;
  ...
  *(std::map< std::string,ParamFormData * > **)&jresult = result; 
  return jresult;
}
...
SWIGEXPORT jlong JNICALL Java_com_my_jcurl_CurlUtilsJNI_new_1ParamFormMap_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  std::map< std::string,ParamFormData * > *arg1 = 0 ;
  std::map< std::string,ParamFormData * > *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  (void)jarg1_;
  arg1 = *(std::map< std::string,ParamFormData * > **)&jarg1;
  if (!arg1) {
...
SWIGEXPORT jlong JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormMap_1size(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  std::map< std::string,ParamFormData * > *arg1 = (std::map< std::string,ParamFormData * > *) 0 ;
  unsigned int result;
  ...
  try {
    result = (unsigned int)((std::map< std::string,ParamFormData * > const *)arg1)->size();
  } catch (std::exception& e) {
    SWIG_JavaException(jenv,SWIG_RuntimeError,e.what());
  }
...
SWIGEXPORT jboolean JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormMap_1empty(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  try {
    result = (bool)((std::map< std::string,ParamFormData * > const *)arg1)->empty();
  } catch (std::exception& e) {
    SWIG_JavaException(jenv,SWIG_RuntimeError,e.what());
  }
...
SWIGEXPORT void JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormMap_1set(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jlong jarg3, jobject jarg3_) {
  std::map< std::string,ParamFormData * > *arg1 = (std::map< std::string,ParamFormData * > *) 0 ;
  std::string *arg2 = 0 ;
  ParamFormData **arg3 = 0 ;
  ParamFormData *temp3 = 0 ;
  ...
  arg2 = &arg2_str;
  jenv->ReleaseStringUTFChars(jarg2, arg2_pstr); 
  temp3 = *(ParamFormData **)&jarg3;
  arg3 = (ParamFormData **)&temp3; 
...
SWIGEXPORT void JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormMap_1del(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  ...
  try {
    try {
      std_map_Sl_std_string_Sc_ParamFormData_Sm__Sg__del(arg1,(std::string const &)*arg2);
    }
    catch(std::out_of_range &_e) {
      SWIG_JavaThrowException(jenv, SWIG_JavaIndexOutOfBoundsException, (&_e)->what());
      return ;
...
SWIGEXPORT jboolean JNICALL Java_com_my_jcurl_CurlUtilsJNI_ParamFormMap_1has_1key(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  ...
  try {
    result = (bool)std_map_Sl_std_string_Sc_ParamFormData_Sm__Sg__has_key(arg1,(std::string const &)*arg2);
  } catch (std::exception& e) {
    SWIG_JavaException(jenv,SWIG_RuntimeError,e.what());
  }
